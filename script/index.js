...
const popupProfileForm = document.forms['profile-form'];  // Поиск форм редактирования информации
const popupCardAddForm = document.forms['place-form'] ; // Поиск форм редактирования информации
